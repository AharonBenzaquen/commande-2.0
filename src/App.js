...
const utilisateurs = {
  'employe@optiw.com': { role: 'employe', password: '1234', magasin: 'Laval' },
  'rosemere@optiw.com': { role: 'employe', password: '1234', magasin: 'Rosemère' },
  'blainville@optiw.com': { role: 'employe', password: '1234', magasin: 'Blainville' },
...
export default function App() {
  ...
  const modifierCommande = (index) => setEditionIndex(index) || setCommande(commandes[index]);
  const supprimerCommande = (index) => setCommandes(commandes.filter((_, i) => i !== index));
